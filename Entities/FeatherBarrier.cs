...
public class FeatherBarrier : Solid {
    private static readonly GetDelegate<Player, float> StarFlyTimerGetter = FastReflection.CreateGetDelegate<Player, float>("starFlyTimer");
    private static readonly GetDelegate<Player, Color> StarFlyColorGetter = FastReflection.CreateGetDelegate<Player, Color>("starFlyColor");
